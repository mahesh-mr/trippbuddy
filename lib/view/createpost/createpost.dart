...
class Createpost extends StatelessWidget {
  Createpost({Key? key, this.isEditing = false, this.newpost, this.image, this.postText,})
      : super(key: key);
  bool isEditing;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<CreatepostController>(initState: (state) {
        // if (isEditing) {
                  ...
                  children: [
                    ...
                    LogButton(
                      ...
                      text_or_icon: TextLines(
                          title: "Select Image", size: 25, fontfamly: logbtn),
